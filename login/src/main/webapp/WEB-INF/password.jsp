...
<div class="container mt-4">
    ...
    <div class="row justify-content-md-center">
        <div class="col-sm-12 col-md-3">
            ...
            <h3>Change Password of ${username}</h3>
            <p>${error}</p>
            <form action="/user/password?username=${username}" method="post" autocomplete="off">

                <%--Password:--%>
                <br/>
                <input type="password" class="form-control" name="password" placeholder="New Password" aria-label="Password"
                ...
                <br><br>
                <button class="btn btn-success" type="submit" value="">Change Password</button>
            </form>
